...
#laravel</div>
                    ...
                    <div class="grid grid-cols-2 gap-3">
                        <a 
                            ...
                            class="flex items-center justify-center gap-2 px-6 py-3 bg-black hover:bg-gray-800 text-white font-semibold rounded-lg transition-all"
                        >
                        ...
                        <a 
                            ...
                            target="_blank" 
                            rel="noopener noreferrer"
                            class="flex items-center justify-center gap-2 px-6 py-3 bg-blue-500 hover:bg-blue-600 text-white font-semibold rounded-lg transition-all"
                        >
                            <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
